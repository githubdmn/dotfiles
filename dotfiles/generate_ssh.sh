generate_rsa_key() {
  ...
  read -p "Enter key type (rsa, ecdsa, ed25519, default: $key_type): " user_type
  ...
  ssh-keygen -t "$key_type" -b "$key_bits" -C "$key_comment" -f "$key_path" -q -N ""

  if [ $? -eq 0 ]; then
    echo "RSA key pair generated successfully!"
    echo "Private key: $key_path"
    echo "Public key: ${key_path}.pub"
    echo "Remember to add your public key to your GitHub or other services."
  else
